...
class Info extends Bank{
    ...
    JLabel desc = new JLabel("<html><head><style>div {text-align: center;}<div><br/> <br/>Dibuat Oleh Kelompok 7<br/>  <br/>1. Muhammad Hilmi Izzulhaq 1101202399<br/>2. Lenggana Bayu Ajie 1101204250 <br/>3. Faravy Widyawan 1101204289</div></html>");
    JButton kembali = new JButton("Kembali");
...
class Pin{
    ...
    public static String mypin = String.valueOf("4411123");
